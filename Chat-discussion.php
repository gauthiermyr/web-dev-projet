...
<body>
    ...
    <div class="container-Chat">
        ...
        <div id="nav-block-contacts1"></div>
        ...
        <div id="nav-block-contacts2"></div>
        ...
        <div id="nav-block-contacts3"></div>
        ...
        <div id="nav-block-contacts4"></div>
        ...
        <div id="nav-block-message"></div>
        <div id="nav-message-recu"> Salut comment vas-tu ? </div>

        <div id="nav-votre-message"> Votre Message : </div>
        <div class="nav-element">
                <input id="input-nav-bar" type="text" placeholder="Message..."></input>
                <button class="hover-translate" onclick="search()">Envoyer</button>
        </div>
